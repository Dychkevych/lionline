		...
		_layout				: function() {
			...
			if( this.support3d && this.supportTrans ) {
				...
				leftCSS 	= {
					...
					'transform'			: 'translateX(-350px) translateZ(-200px) rotateY(0)'
				};
		...
		_getCoordinates		: function( position ) {
			...
			if( this.support3d && this.supportTrans ) {
				...
				switch( position ) {
					...
					case 'left':
						return {
							'-webkit-transform'	: 'translateX(-350px) translateZ(-200px) rotateY(0)',
							'-moz-transform'	: 'translateX(-350px) translateZ(-200px) rotateY(0)',
							'-o-transform'		: 'translateX(-350px) translateZ(-200px) rotateY(0)',
							'-ms-transform'		: 'translateX(-350px) translateZ(-200px) rotateY(0)',
							'transform'			: 'translateX(-350px) translateZ(-200px) rotateY(0)',
							'opacity'			: 0.6,
							'visibility'		: 'visible'
						};
